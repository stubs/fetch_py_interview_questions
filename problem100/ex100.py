...
The integers i and j must appear in the output in the same order in which they appeared in the input and should be followed by the maximum cycle
...
for n in xrange(NUM1, NUM2 + 1):
    ...
    while n != 1:
        if n %2 != 0:
            ...
            n = n/2
        MAX_ITS += 1
    N_CYCLES.append(MAX_ITS)

print NUM1, NUM2, max(N_CYCLES)
