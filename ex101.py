...
are n blocks on the table (numbered from 0 to n-1)
with block bi adjacent to block bi+1
for allas shown in the diagram below:
...
of block a,  and any blocks that are stacked above block a, onto
block b.  All blocks on top of block b are moved to their initial
...
of block a, and any blocks that are stacked above  block a, onto
the top of the stack containing block b.  The blocks stacked above block
a retain their original order when moved.

quit
terminates manipulations in the block world.

Any command in which a = b or in which a and b
...
(i.e., n lines of output where n is the
