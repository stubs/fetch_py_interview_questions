...
archive_analytics.values.service='wb';archive_analytics.values.server_name='wwwb-app45.us.archive.org';archive_analytics.values.server_ms=213;
...
An anniversary line will consist of the letter `A'; three
integer numbers (D, M, P) representing the date, the month and the
...
`D' and the date and month as above.
...
The output should specify the date of the event (D and
M), right justified in fields of width 3, and the relative
