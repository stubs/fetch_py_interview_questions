...
archive_analytics.values.service='wb';archive_analytics.values.server_name='wwwb-app36.us.archive.org';archive_analytics.values.server_ms=413;
...
Given an    matrix of integers, you are to write a
...
a line followed by    integers where m is the row dimension
