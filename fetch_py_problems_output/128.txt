...
archive_analytics.values.service='wb';archive_analytics.values.server_name='wwwb-app19.us.archive.org';archive_analytics.values.server_ms=381;
...
terminated by a line that contains a # in column 1. Note that each CRC printed should be in the range 0 to 34942 (decimal).
