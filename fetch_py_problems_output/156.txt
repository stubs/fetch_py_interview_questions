...
archive_analytics.values.service='wb';archive_analytics.values.server_name='wwwb-app22.us.archive.org';archive_analytics.values.server_ms=408;
...
another word. Such words are called ananagrams, an example is
QUIZ.
...
a relative ananagram (LACES is not in the same domain) but NOTE
